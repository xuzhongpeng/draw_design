...
static NSString* const GMSP_GET = @"GMSP_GET";
...
didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [methodChannel setMethodCallHandler:^(FlutterMethodCall* call, FlutterResult result) {
        if ([saveImageToGallery isEqualToString:call.method]) {
            ...
            NSDictionary *data = @{@"token":@"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOjIxNjQsImF1ZCI6InVzZXIiLCJ0Y3QiOjE1NzYxMzI4Njh9.wxFY9x-EMsibw4rvRo_Eejd5ATh4tgEViektelGe_0s",
                                   @"userId":@1780,
        ...
        }  else if([GMSP_GET isEqualToString:call.method]){
          result(nil);
        }
        else {
